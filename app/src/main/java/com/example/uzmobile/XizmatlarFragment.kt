...
class XizmatlarFragment : Fragment() {
    ...
    private lateinit var xizmatlarPagerAdapter: XizmatlarPagerAdapter
    override fun onCreateView(
        ...
        loadCategories()
        xizmatlarPagerAdapter = XizmatlarPagerAdapter(childFragmentManager, categoryList)
        root.xiz_view_pager.adapter = xizmatlarPagerAdapter
        root.xiz_tab_layout.setupWithViewPager(root.xiz_view_pager)
        setUpTabItems()
        root.xiz_tab_layout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
    ...
    private fun setUpTabItems() {
        val tabCount = root.xiz_tab_layout.tabCount
        for (i in 0 until tabCount) {
            val tabAt = root.xiz_tab_layout.getTabAt(i)
    ...
    private fun loadCategories() {
        ...
        categoryList.add("Xizmatlar")
        categoryList.add("Pullik smslar")
        categoryList.add("Rouming")
    }
